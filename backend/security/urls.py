...
urlpatterns = [
    ...
    path("organizations/<slug:slug>/", OrganizationDetailView.as_view()),
    path("organizations/<slug:slug>/invite/", OrgInviteView.as_view()),
    path("service-accounts/", ServiceAccountListView.as_view()),
    path("service-accounts/<int:pk>/", ServiceAccountDetailView.as_view()),
    path("service-accounts/<int:pk>/rotate-token/", ServiceAccountRotateTokenView.as_view()),
    ...
    path("agents/<str:agent_id>/respond/", AgentRespondView.as_view()),
    path("agents/<str:agent_id>/responses/", AgentResponseHistoryView.as_view()),
    ...
    path("work-package/generate/", WorkPackageGenerateView.as_view()),
    path("work-package/add-more/", WorkPackageAddMoreView.as_view()),
