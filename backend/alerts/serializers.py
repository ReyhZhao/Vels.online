...
class AlertSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Alert
        fields = [
            'id', 'display_id', 'title', 'severity', 'description', 'pap', 'tlp', 'state',
            'source_kind', 'source_ref', 'incident', 'incident_display_id',
            'acknowledged_by', 'acknowledged_at', 'created_at', 'updated_at',
            'org_slug',
        ]
        read_only_fields = [
            'id', 'display_id', 'title', 'severity', 'description', 'pap', 'tlp',
            'source_kind', 'source_ref', 'created_at', 'updated_at', 'org_slug',
        ]
