...
Vels.online turns multi-source security signals into worked, closed incidents. Detections land as **Alerts**, the pipeline filters noise and correlates related signals, and the ones that matter become **Incidents** that flow through IOC enrichment, AI triage, on-call routing, playbooks, and an agentic Incident Assistant. See the [architecture overview](docs/architecture.md) for the full picture.
...
- **[Incident Response](docs/features/incident-response.md)** — the incident lifecycle, on-call scheduling, AI triage, IOC enrichment, the Incident Assistant, cross-org Threat Hunting, phishing ingestion, and incident contacts.
...
- **[Estate Management](docs/features/estate-management.md)** — fleet/asset visibility, vulnerability management, and self-service ingress (reverse proxy & WAF).
- **[Platform](docs/features/platform.md)** — notifications, status page, blog/knowledge base, and multi-organisation access control.
